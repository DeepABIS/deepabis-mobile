...
import de.flynamic.mobileabis.SpeciesFragment.OnListFragmentInteractionListener
import de.flynamic.mobileabis.SpeciesFragment.SpeciesItem
...
class SpeciesRecyclerViewAdapter(
        private val mValues: List<SpeciesItem>,
